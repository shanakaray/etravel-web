...
<%@ page import="java.util.List,
                 ...
                 java.net.URLEncoder,
                 java.util.HashMap"%>
<%@page import="com.yd.etravel.util.ServiceHelper"%>
...
<%! // Define Constants
    ...
    static final String SECURE_SECRET = ServiceHelper.getInstance().getIpgUtil().getSecureSecret();
...
%><%// *******************************************
	...
	for (Enumeration enu = request.getAttributeNames(); enu.hasMoreElements();) {
		...
		String fieldValue = request.getAttribute(fieldName).toString();
		if ((fieldValue != null) && (fieldValue.length() > 0)) {
